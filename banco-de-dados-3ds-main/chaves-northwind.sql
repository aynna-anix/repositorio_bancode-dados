...
ALTER TABLE CategoryProduct ADD PRIMARY KEY (CategoryID);
...
ALTER TABLE Products ADD CONSTRAINT FK_Products_Category FOREIGN KEY (CategoryID) REFERENCES CategoryProduct(CategoryID);
